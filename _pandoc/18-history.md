...
- Add support for bilibili videos in [responsive video helper](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#responsive-video-embed). [#2512](https://github.com/mmistakes/minimal-mistakes/pull/2512)
...
- Add [Dracula](https://draculatheme.com/) Base16 syntax highlighting theme Sass variables to [stylesheets documentation](https://mmistakes.github.io/minimal-mistakes/pandoc/stylesheets/#syntax-highlighting). [#2438](https://github.com/mmistakes/minimal-mistakes/pull/2438)
...
- Update [`compress` layout](https://mmistakes.github.io/minimal-mistakes/pandoc/layouts/#compress-layout) to v3.1.0. [#2128](https://github.com/mmistakes/minimal-mistakes/pull/2128)
...
- Use privacy aware embed options for YouTube and Vimeo in [responsive video helper](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#responsive-video-embed). [#1964](https://github.com/mmistakes/minimal-mistakes/pull/1964)
...
- Add support to [gallery helper](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#gallery) for defining column layout (`half`, `third`, or single `''`). [#1821](https://github.com/mmistakes/minimal-mistakes/issues/1821)
...
- Fix "Back to Top" links on pages that use [header overlays](https://mmistakes.github.io/minimal-mistakes/pandoc/layouts/#header-overlay).
...
- Fix code block extra white-space when using [Jekyll's highlight tag](https://jekyllrb.com/pandoc/templates/#code-snippet-highlighting) with `linenos`. [#1437](https://github.com/mmistakes/minimal-mistakes/issues/1437)
...
- Extend [archive grid view](https://mmistakes.github.io/minimal-mistakes/pandoc/layouts/) to the right to better fill the page.
...
- Add comments to `/pandoc/_config.yml` to clarify use of YAML references. [#847](https://github.com/mmistakes/minimal-mistakes/pull/847)

## [4.2.1](https://github.com/mmistakes/minimal-mistakes/releases/tag/4.2.1)

### Enhancements

- Improve `paginator.html` to support paginated pages that live inside of a subfolder. See [documentation](https://mmistakes.github.io/minimal-mistakes/pandoc/layouts/#home-page) for more details. [#764](https://github.com/mmistakes/minimal-mistakes/pull/764/)
...
- Add Google AdSense banner to `/pandoc/_layouts/default.html` for demo site.
...
- Add [`figure` helper](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#figure) to make generating a `<figure>` element with a single image and caption easier. [#572](https://github.com/mmistakes/minimal-mistakes/pull/572)
...
- Add "[Overriding Theme Defaults](https://mmistakes.github.io/minimal-mistakes/pandoc/overriding-theme-defaults/)" page to documentation.
...
- Replace Sass and Autoprefixer `npm` build scripts with [Jekyll's built-in asset support](https://jekyllrb.com/pandoc/assets/). [#333](https://github.com/mmistakes/minimal-mistakes/issues/333)
...
- Add support for [header overlay images](https://mmistakes.github.io/minimal-mistakes/pandoc/layouts/#header-overlay) for Open Graph images. [#358](https://github.com/mmistakes/minimal-mistakes/pull/358)
...
- Add support for image captions in Magnific Popup overlays via the [`gallery`](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#gallery) helper [#334](https://github.com/mmistakes/minimal-mistakes/issues/334)
...
- Explain how to use `nav_list` helper in [documentation](https://mmistakes.github.io/minimal-mistakes/pandoc/helpers/#navigation-list).
...
- Removed Google Fonts and replaced with system fonts to improve performance (they can be [added back](https://mmistakes.github.io/minimal-mistakes/pandoc/stylesheets/) if desired)
- Greatly improved [theme documentation](https://mmistakes.github.io/minimal-mistakes/pandoc/quick-start-guide/).
...
- Added a [UI text data file](https://mmistakes.github.io/minimal-mistakes/pandoc/ui-text/) to easily change all text found in the theme.
