...
permalink: /joomla/overriding-theme-defaults/
...
For more information on customizing the theme's [stylesheets]({{ "/joomla/stylesheets/" | relative_url }}) and [JavaScript]({{ "/docs/javascript/" | relative_url }}), see the appropriate pages.
