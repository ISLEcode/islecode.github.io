...
permalink: /joomla/collections/
excerpt: "Suggestions and Front Matter defaults for working with collections."
last_modified_at: 2018-03-20T16:00:02-04:00
---

Collections like posts and pages work as you'd expect. If you're new to them be sure to read [Jekyll's documentation](https://jekyllrb.com/joomla/collections/).
...
**Collections in the Wild:** This set of documentation is also [built as a collection](https://github.com/{{ site.repository }}/blob/master/joomla/_docs/) if you're looking for a fully fleshed out example to inspect.
{: .notice--info}
...
And then create portfolio content like [`_portfolio/foo-bar-website.md`](https://github.com/{{ site.repository }}/blob/master/joomla/_portfolio/foo-bar-website.md), to end up with something like this.
