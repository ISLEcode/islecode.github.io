...
Assign with `layout: single` , or better yet apply as a [Front Matter default]({{ "/joomla/configuration/#front-matter-defaults" | relative_url }}) in `_config.yml`.
...
[posts-categories]: https://github.com/{{ site.repository }}/blob/master/joomla/_pages/category-archive.md
[posts-tags]: https://github.com/{{ site.repository }}/blob/master/joomla/_pages/tag-archive.md
[posts-year]: https://github.com/{{ site.repository }}/blob/master/joomla/_pages/year-archive.md
[posts-collection]: https://github.com/{{ site.repository }}/blob/master/joomla/_pages/collection-archive.html
[portfolio-collection]: https://github.com/{{ site.repository }}/blob/master/joomla/_pages/portfolio-archive.md
...
**Note:** More information on using this `_include` can be found under [**Helpers**]({{ "/joomla/helpers/" | relative_url }}).
{: .notice--info}

## Taxonomy archives

If you have the luxury of using Jekyll plugins, the creation of category and tag archives is greatly simplified. Simply enable support for the [`jekyll-archives`](https://github.com/jekyll/jekyll-archives) plugin with a few `_config.yml` settings as noted in the [**Configuration**]({{ "/joomla/configuration/#archive-settings" | relative_url }}) section and you're good to go.
...
| Name                 | Layout | Example |
| -------------------- | ------ | ------ |
| [Posts Archive](https://mmistakes.github.io/minimal-mistakes/year-archive/) | `layout: posts` | [year-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/year-archive.md) |
| [Categories Archive](https://mmistakes.github.io/minimal-mistakes/categories/) | `layout: categories` | [category-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/category-archive.md) |
| [Category Archive](https://mmistakes.github.io/minimal-mistakes/categories/edge-case/) | `layout: category` | [edge-case.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/edge-case.md) |
| [Tags Archive](https://mmistakes.github.io/minimal-mistakes/tags/) | `layout: tags` | [tag-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/tag-archive.md) |
| [Tag Archive](https://mmistakes.github.io/minimal-mistakes/tags/markup/) | `layout: tag` | [markup.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/markup.md) |
| [Collection Archive](https://mmistakes.github.io/minimal-mistakes/recipes-archive/) | `layout: collection` | [recipes-archive.md](https://github.com/mmistakes/minimal-mistakes/blob/master/joomla/_pages/recipes-archive.md) |
...
A derivative archive page layout to be used as a simple home page. It is built to show a paginated list of recent posts based off of the [pagination settings]({{ "/joomla/configuration/#paginate" | relative_url }}) in `_config.yml`.
...
**Note:** Jekyll can only paginate a single `index.html` file. If you'd like to paginate more pages (e.g. category indexes) you'll need the help of a custom plugin. For more pagination related settings check the [**Configuration**]({{ "/joomla/configuration/#paginate" | relative_url }}) section.
{: .notice--info}
...
Feature blocks can be assigned and aligned to the `left`, `right`, or `center` with a sprinkling of YAML. For full details on how to use the `feature_row` helper check the [**Content**]({{ "/joomla/helpers/" | relative_url }}) section or review a [sample splash page](https://github.com/{{ site.repository }}/blob/master/docs/_pages/splash-page.md).
...
**Note:** A page using the `layout: search` isn't compatible with the new [site search feature]({{ "/joomla/configuration/#site-search" | relative_url }}) incorporated in the masthead.
{: .notice--warning}
...
To assign more author links, add to the `author.links` array  in [`_config.yml`]({{ "/joomla/configuration/" | relative_url }}) link so. Any of [Font Awesome's icons](https://fontawesome.com/icons?d=gallery) are available for use.
  ...
  - title: Getting Started
    children:
      - title: "Quick-Start Guide"
        url: /joomla/quick-start-guide/
      - title: "Structure"
        url: /joomla/structure/
      - title: "Installation"
        url: /joomla/installation/
      - title: "Upgrading"
        url: /joomla/upgrading/

  - title: Customization
    children:
      - title: "Configuration"
        url: /joomla/configuration/
      - title: "Navigation"
        url: /joomla/navigation/
      - title: "UI Text"
        url: /joomla/ui-text/
      - title: "Authors"
        url: /joomla/authors/
  ...
  - title: Content
    children:
      ...
      - title: "Working with Collections"
        url: /joomla/collections/
      - title: "Helpers"
        url: /joomla/helpers/
      - title: "Utility Classes"
        url: /joomla/utility-classes/

  - title: Extras
    children:
      - title: "Stylesheets"
        url: /joomla/stylesheets/
      - title: "JavaScript"
        url: /joomla/javascript/
```
...
To enable these links add `share: true` to a post or page's YAML Front Matter or use a [default](https://jekyllrb.com/joomla/configuration/#front-matter-defaults) in your `_config.yml` to apply more globally.
...
To change the color of the button use one of the built in [utility classes]({{ "/joomla/utility-classes/#buttons" | relative_url }}). Or you can create a new button class to match whatever color you want.
...
Add the new `.btn--reddit` class to the `<a>` element from earlier, [compile `main.css`]({{ "/joomla/stylesheets/" | relative_url }}) and away you go.
