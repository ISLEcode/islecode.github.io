...
Feature and thumbnail images are used by [Open Graph](https://developers.facebook.com/joomla/opengraph/) and [Twitter Cards](https://dev.twitter.com/docs/cards) as well. If you don't assign a thumbnail the default graphic *(default-thumb.png)* is used. I'd suggest changing this to something more meaningful --- your logo or avatar are good options.

**Pro-Tip**: You need to [apply for Twitter Cards](https://dev.twitter.com/joomla/cards) before they will begin showing up when links to your site are shared.
{:.notice}
